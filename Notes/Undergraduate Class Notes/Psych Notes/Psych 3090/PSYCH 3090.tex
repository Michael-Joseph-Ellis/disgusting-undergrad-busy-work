...
\begin{itemize}
    \item Used when you have:
    \begin{itemize}
        \item One DV 
        \item Two IVs
    \end{itemize}
    \item Answers 3 Questions:
    \begin{itemize}
        \item Is there a main effect of IV A?
        \item Is there a main effect of IV B?
        \item Is there an interaction between the two IVs?
    \end{itemize}
\end{itemize}

\subsubsection{Describing 2-way ANOVA
Often you'll hear analyses described like this: 
\begin{itemize}
    \item "A 4 x 2 between-subjects ANOVA"
    \begin{itemize}
        \item This experiment has two IVs:
        \item One IV has 4 levels, one has 2 levels.
        \item Both are manipulated between-subjects.
        \item So there are 4 x 2 = 8 groups.
    \end{itemize}
\end{itemize}
