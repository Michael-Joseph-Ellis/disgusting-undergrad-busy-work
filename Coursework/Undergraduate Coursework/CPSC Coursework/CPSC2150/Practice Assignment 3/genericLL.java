...
public class genericLL<T>
{
     ...
     *
     * @pre |self| (length of self, in this case the linked list) > 0 AND curr != null
     *
     * @post getCurr = [value at curr pointer] AND self = #self
     *
     ...
     *
     * @pre none (what it should be is |self| > 0 AND curr != null)
     *
     ...
     *
     * @pre |self| > 0 AND curr != null AND curr.link != null
     *
